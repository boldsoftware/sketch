  ...
  render() {
    return html`
      ...
      >
        ...
        >
          <h2 class="text-2xl font-semibold mb-6 text-center text-gray-800 dark:text-neutral-200">
            How to use the Diff View
          </h2>

          <p class="text-gray-600 dark:text-neutral-400 leading-relaxed text-base text-left mb-4">
          ...
          <p class="text-gray-600 dark:text-neutral-400 leading-relaxed text-base text-left mb-4">
            ...
            >, you can
            <strong class="font-semibold text-gray-800 dark:text-neutral-200">edit</strong> the text
